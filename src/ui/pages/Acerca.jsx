            ...
            <div className='w-full md:w-2/3 lg:w-2/3 2xl:w-2/3'>
                <div className="flex items-center justify-center">
                    ...
                    <div className="text-brown text-center md:text-left text-[12px] md:text-lg xl:text-[23px] px-0 md:px-0 xl:px-0 ml-0 md:ml-14 grid md:hidden ">
                        <p className='primary leading-4 md:leading-7 py-4 md:py-0 text-justify mt-5 md:mt-0'><a className='sextary'>Distrito Yaax®</a> es un proyecto conceptualizado y desarrollado por ALMIRA DESARROLLOS. Empresa 100 % Mexicana comprometida con el desarrollo económico y social de la región.</p>
      ...
      <section data-animate-in="up" id="verdes" className='mx-auto py-2 md:py-0 px-4 md:px-20 2xl:px-32 mt-10 md:mt-24 3xl:mt-28 mb-24 md:mb-24'>
        ...
        <div className='md:flex py-0 md:py-20 xl:py-14'>
            <div className='w-full'>
                <div className="flex items-center justify-center">
                    <div className="text-brown text-center md:text-left text-[11px] md:text-lg xl:text-[23px] 3xl:text-[28px] hidden md:grid">
                        <p className='primary leading-none md:leading-7 3xl:leading-9 py-4 md:py-0 text-justify'>Distrito Yaax se presenta como un oasis urbano donde el respeto por el entorno natural es una prioridad fundamental. Contamos con un equipo de biólogos apasionados que trabajan incansablemente en la conservación de la flora y fauna locales. Este compromiso se refleja en nuestro sorprendente 60% de áreas verdes meticulosamente integradas, totalizando 45,000 metros cuadrados de zonas verdes.</p>
                        <p className='primary leading-none md:leading-7 3xl:leading-9 py-4 md:py-0 text-justify md:mt-8'>Nuestro ambicioso programa de reforestación va más allá de la siembra de árboles; se trata de preservar la biodiversidad. Guiados por la mano expertos sembramos plantas en peligro de extinción nativas de la zona, asegurando no solo la regeneración del ecosistema, sino también la protección de los habitats esenciales para las especies locales. Cada espacio verde ha sido cuidadosamente planificado para fomentar la conexión íntima con la naturaleza, creando un refugio único donde la sostenibilidad se fusiona armoniosamente con la elegancia.</p>
                    </div>
                    <div className="text-brown text-center md:text-left text-[12px] md:text-lg xl:text-[23px] grid md:hidden">
                        <p className='primary leading-4 md:leading-7 mt-0 md:mt-2 py-4 md:py-0 text-justify'>Distrito Yaax se presenta como un oasis urbano donde el respeto por el entorno natural es una prioridad fundamental. Contamos con un equipo de biólogos apasionados que trabajan incansablemente en la conservación de la flora y fauna locales. Este compromiso se refleja en nuestro sorprendente 60% de áreas verdes meticulosamente integradas, totalizando 45,000 metros cuadrados de zonas verdes.</p>
                        <p className='primary leading-4 md:leading-7 md:mt-2 text-justify mt-4'>Nuestro ambicioso programa de reforestación va más allá de la siembra de árboles; se trata de preservar la biodiversidad. Guiados por la mano expertos sembramos plantas en peligro de extinción nativas de la zona, asegurando no solo la regeneración del ecosistema, sino también la protección de los habitats esenciales para las especies locales. Cada espacio verde ha sido cuidadosamente planificado para fomentar la conexión íntima con la naturaleza, creando un refugio único donde la sostenibilidad se fusiona armoniosamente con la elegancia.</p>
                    </div>
                </div>
            </div>
        </div>
