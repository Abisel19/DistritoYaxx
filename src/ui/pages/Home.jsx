...
function Home() {
  ...
  return (
    <>
        ...
        <div className='md:flex py-0 md:py-20 xl:py-24'>
            <div className='w-full md:w-1/3 xl:w-1/3'>
                <div className="flex items-center justify-center">
                    <div className="text-brown text-3xl md:text-5xl xl:text-[55px] tracking-wider mt-0 md:mt-2 ml-0 md:-ml-10">
                        <h1 className='secondary md:leading-[4rem]'><a className='primary'>¿</a>QUI<span className="font-semibold">E</span>NES<br />SOMOS<a className='primary'>?</a></h1>
                    </div>
                </div>
            </div>
      ...
      <section className='hidden md:flex container w-full mx-auto px-10 pt-0 md:pt-40'>
        <div className='flex'>
      ...
      <section className='bg-black-1 -mt-1 md:mt-0 py-2 md:py-4'>
        <div className='flex container mx-auto px-0 md:px-40 2xl:px-40 pb-8 md:mb-12 xl:mb-20'>
            <div className='flex mx-auto justify-center align-item'>
                <h2 className='secondary text-white mx-auto text-5xl md:text-[110px] xl:text-[140px] 2xl:text-[190px] md:tracking-widest absolute z-10 text-center mt-2 md:mt-8'>A L I A N Z A S</h2>
            </div>
        </div>
      </section>
      ...
      <section className='hidden md:flex bg-gray-1 py-28'>
        <div className='container mx-auto flex'>
            ...
            <div className='w-full md:w-1/5 mx-auto'>
                <svg xmlns="http://www.w3.org/2000/svg" className='mx-auto' width="2" height="300" viewBox="0 0 2 456">
            ...
            <div className='w-2/5'>
                <h3 className='secondary text-base md:text-5xl text-white '>DUDAS</h3>
                <h4 className='primary text-base md:text-lg text-white mt-0 md:mt-1'>SIEMPRE DISPONIBLE PARA TI</h4>
                <div className='mt-2 md:mt-12 flex'>
                <svg xmlns="http://www.w3.org/2000/svg" className='w-6' viewBox="0 0 38.547 27.591">
                    ...
                    <a href="mailto:informes@distritoyaax.com" className='primary text-base md:text-lg text-white ml-0 md:ml-5'>informes@distritoyaax.com</a>
                </div>

                <div className='mt-2 md:mt-4 flex'>
                <svg xmlns="http://www.w3.org/2000/svg" className='w-5' viewBox="0 0 31.766 35.438">
                    ...
                    <a href="tel:+52 9981828289" className='primary text-base md:text-lg text-white ml-0 md:ml-5'>+52 9981828289</a>
                </div>
